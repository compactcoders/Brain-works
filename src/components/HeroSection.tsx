  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <span className="text-gradient block transition-all duration-500 group-hover:drop-shadow-[0_0_60px_rgba(139,92,246,0.8)] group-hover:text-white">BRAIN</span>
          <span className="text-gradient block transition-all duration-500 group-hover:drop-shadow-[0_0_60px_rgba(139,92,246,0.8)] group-hover:text-white">VOICE</span>
        </motion.h1>
